...
const Services = () => {
  return (
    <section id="services" className={`${classes.services}  `}>
      <h2 className="text-8xl text-heading-color font-bold mb-20 text-center ">
        SERVICES
      </h2>
      <p className={`${classes.heading} font-bold text-5xl`}>Services</p>
      <div
        className={`${classes["main-box"]} flex justify-center items-center gap-9`}
      >
        <div className={classes["sec-box"]}>
          <svg
            width="104"
            height="104"
            viewBox="0 0 104 104"
          ...
          <p className="text-4xl font-bold"> Car sales </p>
        ...
        <div className={classes["sec-box"]}>
          ...
          <p className="text-4xl font-bold">Car rental</p>
          <p className={classes.description}>
        ...
        <div className={classes["sec-box"]}>
          ...
          <p className="text-4xl font-bold">Car selling</p>
          <p className={classes.description}>
